#!/bin/bash
outputname=000008_LHC23zzm_JetPt0_NewTM_Occupancy_PbPb_Test
...
python3 runGammaJetTreeProducer.py --input=/software/flo/CalorimeTree/tools/LocalRunConfigs/PbPb_ProduceJEDerived/inputGridLHC23zzm.txt --output=/alf/data/calorimetrees/je_derived_data/JE_LHC23zzm_pass4_Cl_8_Test --configuration=/software/flo/CalorimeTree/tools/LocalRunConfigs/PbPb_ProduceJEDerived --nFilesPerJob=1 --partition=long
