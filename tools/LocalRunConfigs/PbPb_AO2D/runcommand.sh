...
o2-analysis-je-jet-deriveddata-writer -b --configuration json://configuration.json | o2-analysis-je-jet-deriveddata-trigger-producer -b --configuration json://configuration.json | o2-analysis-je-jet-deriveddata-producer -b --configuration json://configuration.json | o2-analysis-je-jet-deriveddata-producer-dummy -b --configuration json://configuration.json | 
o2-analysis-je-jet-finder-data-charged -b --configuration json://configuration.json | o2-analysis-je-estimator-rho -b --configuration json://configuration.json | o2-analysis-je-subtractor-eventwiseconstituent -b --configuration json://configuration.json | o2-analysis-je-jet-finder-charged-qa -b --configuration json://configuration.json | 
o2-analysis-timestamp -b --configuration json://configuration.json | o2-analysis-ft0-corrected-table -b --configuration json://configuration.json | o2-analysis-event-selection -b --configuration json://configuration.json | o2-analysis-multiplicity-table -b --configuration json://configuration.json | o2-analysis-track-propagation -b --configuration json://configuration.json | o2-analysis-je-emcal-correction-task -b --configuration json://configuration.json | o2-analysis-trackselection -b --configuration json://configuration.json | o2-analysis-centrality-table -b --configuration json://configuration.json |
o2-analysis-je-gamma-jet-tree-producer  -b --configuration json://configuration.json --aod-file @input_data.txt --aod-writer-json OutputDirector.json
